...
import './App.css';
import moon from 'F:/REACTJS_S/frontend2/src/assets/moon.jpg';
import sun from 'F:/REACTJS_S/frontend2/src/assets/sun.jpg';
import Header from './Components/Header/Header.js';
import KeyPad from 'F:/REACTJS_S/frontend2/src/Components/KeyPad/KeyPad.js';
    ...
    <div className="App" tabIndex="0"
      ...
      <div className="Calculator">
        <div className="Calculator_Navbar">
          <div className="Calculator_Navbar_Toggle" onClick={()=>setIsDarkMode(!isDarkMode)}>
            <div className={`Calculator_Navbar_Toggle_Circle ${isDarkMode ? "Calculator_Navbar_Toggle_Circle_Active":""}`}/>
          </div>
